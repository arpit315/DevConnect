...
import { FiHeart, FiMessageSquare, FiShare2, FiImage, FiSend, FiMoreHorizontal, FiBriefcase } from 'react-icons/fi';
...
const Home = () => {
    ...
    return (
        <div className="relative max-w-[680px] mx-auto py-10 z-10 sm:px-0 px-4">
                        ...
                        <form className="flex-1" onSubmit={handleCreatePost}>
                            ...
                            <div className="mt-4 flex justify-between items-center px-1">
                                <div className="flex items-center gap-1">
                                    <button type="button" className="text-slate-500 hover:text-primary hover:bg-primary/5 p-2 rounded-xl transition-all flex items-center gap-2 group">
                    ...
                    {loading ? (
                        ...
                        posts.map((post, index) => (
                            ...
                            >
                                ...
                                {/* Media Attachment */}
                                {post.image && (
                                    <div className="mt-4 mb-4 rounded-2xl overflow-hidden shadow-sm border border-slate-100 group">
            ...
            {/* Soft fade-out at bottom to blend with background */}
            {user && (
                <div className="h-20 bg-gradient-to-t from-background to-transparent mt-8 pointer-events-none sticky bottom-0"></div>
            )}
        </div>
    );
};
